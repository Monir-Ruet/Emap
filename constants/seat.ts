...
const Dhaka_1 = ["Dhaka_1_1"];
const Dhaka_2 = ["Dhaka_2_1"];
const Dhaka_3 = ["Dhaka_3_1"];
const Dhaka_4 = ["Dhaka_4_1"];
const Dhaka_5 = ["Dhaka_5_1"];
const Dhaka_6 = ["Dhaka_6_1"];
const Dhaka_7 = ["Dhaka_7_1"];
const Dhaka_8 = ["Dhaka_8_1"];
const Dhaka_9 = ["Dhaka_9_1"];
const Dhaka_10 = ["Dhaka_10_1"];
const Dhaka_11 = ["Dhaka_11_1"];
const Dhaka_12 = ["Dhaka_12_1"];
const Dhaka_13 = ["Dhaka_13_1"];
const Dhaka_14 = ["Dhaka_14_1"];
const Dhaka_15 = ["Dhaka_15_1"];
const Dhaka_16 = ["Dhaka_16_1"];
const Dhaka_17 = ["Dhaka_17_1"];
const Dhaka_18 = ["Dhaka_18_1"];
